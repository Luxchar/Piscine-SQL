...
CASE
WHEN Country IN ('Argentina', 'Brazil', 'Canada', 'Chile', 'Colombia', 'Cuba', 'Dominican Republic', 'Ecuador', 'El Salvador', 'Guatemala', 'Haiti', 'Honduras', 'Jamaica', 'Mexico', 'Nicaragua', 'Panama', 'Peru', 'Puerto Rico', 'United States', 'Uruguay', 'Venezuela') THEN 'America'
